        ...
        <div class="content">
            ...
            <div class = "gallery">
                            ...
                            while($row_data=mysqli_fetch_assoc($result_prod)){
                                ...
                                echo '<img class = "prod-image" src="https://png.pngtree.com/png-clipart/20190904/original/pngtree-retro-book-free-material-png-image_4481187.jpg" alt="Product 2" width="100" height="100">';
